...
# ------------------------------------------------------------------------------
# Meta rule to get all matrixEQTL input files from the dosage files. Needs to be run before calling the 'all' rule
...
# ------------------------------------------------------------------------------
# Target rule to run complete workflow (uses output definitions from 'run_matrixeqtl' rule)
# ------------------------------------------------------------------------------
rule all:
	input:
